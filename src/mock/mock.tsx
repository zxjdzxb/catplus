...
export const mockItemSummary: Mock = (config) => {
  ...
  if (group_by === 'happen_at' && kind === 'expenses') {
    return [
      ...
      {
        groups: [
          { happen_at: '2023-03-18T16:00:00.000Z', amount: 100 },
          { happen_at: '2023-03-22T16:00:00.000Z', amount: 300 },
          { happen_at: '2023-03-26T16:00:00.000Z', amount: 200 }
        ],
        summary: 600
      }
    ]
    ...
    return [
      ...
      {
        groups: [
          { happen_at: '2023-03-08T16:00:00.000Z', amount: 100 },
          { happen_at: '2023-03-12T16:00:00.000Z', amount: 300 },
          { happen_at: '2023-03-19T16:00:00.000Z', amount: 200 }
        ],
        summary: 600
      }
    ]
